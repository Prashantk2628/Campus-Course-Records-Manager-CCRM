        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "6":
                    ...
                    courseService.findByCode(courseCode).ifPresentOrElse(
                        Course::deactivate,
                ...
                case "7":
                    ...
                    String enrollSid = sc.nextLine();
                    System.out.print("Enter Course Code: ");
                    String enrollCode = sc.nextLine();
                    studentService.findById(enrollSid).ifPresentOrElse(
                        student -> courseService.findByCode(enrollCode).ifPresentOrElse(
                ...
                case "8":
                    System.out.print("Enter Student ID: ");
                    String unenrollSid = sc.nextLine();
                    System.out.print("Enter Course Code: ");
                    String unenrollCode = sc.nextLine();
                    studentService.findById(unenrollSid).ifPresentOrElse(
                        student -> courseService.findByCode(unenrollCode).ifPresentOrElse(
                ...
                case "10":
                    System.out.print("Enter Student ID: ");
                    String gradeSid = sc.nextLine();
                    System.out.print("Enter Course Code: ");
                    String gradeCode = sc.nextLine();
                    System.out.print("Enter Grade (S/A/B/C/D/F): ");
                    String g = sc.nextLine();
                    studentService.findById(gradeSid).ifPresentOrElse(
                        student -> courseService.findByCode(gradeCode).ifPresentOrElse(
                ...
                case "11":
                    System.out.print("Enter Student ID: ");
                    String gpaSid = sc.nextLine();
                    studentService.findById(gpaSid).ifPresentOrElse(
                ...
                case "12":
                    System.out.print("Enter Student ID: ");
                    String transcriptSid = sc.nextLine();
                    studentService.printTranscript(transcriptSid);
                    break;
                case "13":
                ...
                case "14":
                    try {
                        ...
                        String courseFile = sc.nextLine();
                        importService.importCourses(courseFile, courseService);
                        System.out.print("Enter Enrollments CSV file path: ");
                        String enrollFile = sc.nextLine();
